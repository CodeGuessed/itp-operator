...
export const SHIFT_DEFS = {
  NIGHT:  { key: 'NIGHT',  label: 'Night',  code: '[N] Night shift',  short: 'N',   color: 'violet', start: '17:30', end: '06:00', nextDay: true  },
  DAY:    { key: 'DAY',    label: 'Day',    code: '[D] Day shift',    short: 'D',   color: 'amber',  start: '05:30', end: '18:00', nextDay: false },
  CSHIFT: { key: 'CSHIFT', label: 'C-Shift',code: '[C11] C-shift',    short: 'C',   color: 'teal',   start: '11:00', end: '23:00', nextDay: false },
